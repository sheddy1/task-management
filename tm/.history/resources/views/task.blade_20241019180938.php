...
<body>
    ...
    <div class="create_project_box" id="create_project_box">
        ...
        <form action="{{ route('create_project') }}" method="post">
            ...
            <text class="create_project_box_input_txt1">Name</text>

            <select name="project_input_select" id="" class="create_project_box">
                <options selected disabled>Select Project</options>
            </select>
