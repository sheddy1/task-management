...
<body>
    <div class="register">
        ...
        {{--  form for input  --}}
        <form method="post" class="register_form" action="{{ route('check') }}">
            @csrf
            ...
            <button class="register_button">Sign In</button>
            <h4 class="register_sigin">I don’t have an Account? <a href="{{ route('check_task') }}" class="register_link">sign Up</a></h4>
        </form>
    </div>
</body>
</html>
