...
<body>
    ...
    <div class="edit_project_box" id="edit_project_box" style="display: {{ $edit_display }}">
        ...
        <form action="{{ route('edit_close') }}" method="get">
...
<script>
    ...
    const close_create = document.getElementById("edit_project_box_close");

    close_create.addEventListener("click", (event) => {
        document.getElementById("edit_project_box").style.display = "none";
    });
