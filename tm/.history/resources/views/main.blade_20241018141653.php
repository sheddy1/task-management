...
<body>
    ...
    <div class="create_project_box" id="create_project_box">
        ...
        <img src="{{ asset('images/close.png') }}" alt="close" class="create_project_box_close">

        {{--  input for create project box  --}}
        <text class="create_project_box_input_txt">Name</text>

        <input type="textarea" class="create_project_box_input">

        <textarea name="" id="" cols="30" rows="10" class="create_project_box_input"></textarea>
    </div>
</body>
