...
<body>
    ...
    <div class="header">
        ...
        <div class="extension">
            <img src="{{ asset('images/user1.png') }}" alt="user" class="extension_image">
            <button class="extension_button">Logout</button>
        </div>
    </div>
    ...
    <div class="project_box">
        ...
        <div class="project_box_section">
            <form action="{{ route('project_folder_change') }}" method="post">
                @csrf
                <button class="project_box_section_folder1">
                    <img src="{{ asset('images/folder.png') }}" class="project_box_section_folder"
                    id="project_box_section_folder" alt="folder">
                </button>
                <input type="text" name="project_folder_change" value={{ $data->unique_id }} style="display:none">
            </form>
